              ...
              <div>
                ...
                <div className="space-y-4 text-white/80">
                  <p>
                    ...
                    founder Alex Johnson to solve his own struggles with waking
                    up refreshed. What started as a personal project quickly
                    grew into a suite of time-related tools used by thousands
                    worldwide.
                  </p>
                  <p>
                    We believe that understanding and managing time should be
                    effortless. Our calculators remove the complexity from time
                    calculations, letting you focus on what matters most.
                  </p>
                  <p>
                    Every tool we build is designed with precision, beauty, and
                    simplicity in mind. We obsess over details to create
