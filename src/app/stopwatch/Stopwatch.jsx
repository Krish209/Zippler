  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-purple-900 p-4 sm:p-6">
      <div className="pt-20 pb-10">
        <div className="w-full mx-auto max-w-md bg-white/5 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border border-white/10 transition-all duration-300 hover:shadow-blue-500/20">
          {/* Header */}
