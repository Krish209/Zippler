...
export default function SpeedChallenge() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-indigo-900 p-4 sm:p-6">
      <div className="pt-20">
        <div className="w-full mx-auto max-w-md bg-white/5 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border border-white/10">
          {/* Header */}
          ...
          <div className="p-6 space-y-8">
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-sm">
                    ...
                    {Math.abs(TARGET_TIME - time).toFixed(2)}s{" "}
                    {time > TARGET_TIME ? "over" : "under"})
                  </p>
                  <p className="text-lg font-bold mt-2">
                    ...
                    <span className="text-amber-400">
                      {Math.max(
                        0,
                        100 - Math.round(Math.abs(TARGET_TIME - time) * 100)
                      )}
                    </span>
                    /100
                  </p>
                    ...
                    >
                      <div>
                        ...
                        <span className="text-xs text-white/60 ml-2">
                          ({Math.abs(TARGET_TIME - attempt.time).toFixed(2)}s{" "}
                          {attempt.time > TARGET_TIME ? "over" : "under"})
                        </span>
                      </div>
                      <span
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <ul className="text-sm text-white/70 space-y-1">
                ...
                <li>
                  • Press "Stop" when you think it's exactly 10.00 seconds
                </li>
                <li>
                  • The closer you are, the higher your score (100 = perfect)
                </li>
